                    ...
                    <div class="card">
                        ...
                        <div class="collapse" id="permissionsHelp">
                            <div class="card-body bg-light">
                                <h6>Management Levels & Permissions:</h6>
                                <ul class="mb-0">
                        ...
                        <div class="card-body">
                            <div id="permission-notice" class="alert alert-info" style="display: none;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterPermissions() {
            ...
            // If no level selected, hide all permissions
            if (!selectedLevel) {
                ...
                permissionNoticeText.textContent = levelDescriptions[''];
        ...
        // Initial filter - hide all permissions until level is selected
        filterPermissions();
    });
</script>
@endpush
